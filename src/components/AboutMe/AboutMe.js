...
const screenConstants = { 
    description: "Full stack web and mobile developer with background knowledge of MERN stacks, along with a knack of building applications.",
    highlights: {
        bullets: [
          ...
          <div className="about-me-card">
            ...
            <div className="about-me-details">
              ...
              <div className="about-me-options">
                <button className="btn btn-primary" onClick={() => ScrollService.scrollHandler.scrollToHireMe()}> Hire Me </button>
